...
public class Banky {
    ...
    private static final String password = "root2314";
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        try{
            ...
            Manager manager = new Manager(connection, sc);
                    ...
                    case 2:
                        ...
                        if(email!=null){
                            ...
                            while (choice2 != 5) {
                                ...
                                switch (choice2) {
                                    case 1:
                                        manager.debit_money(account_number);
                                        break;
                                    case 2:
                                        manager.credit_money(account_number);
                                        break;
                                    case 3:
